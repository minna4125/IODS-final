...
```{r, eval=TRUE, warning=FALSE}
    ...
    #Printing out the odds ratios with their confidence intervals
     cbind(OR, CI)
```
#####From the oddratios we can conclude that positive effect on anime being liked is genre clusters 3,4 and 5 (Funny -, human relationships-, and mystery/sci-fi animes).Also the number of members and episodes have an positive effect. Other variables have negative effect.
